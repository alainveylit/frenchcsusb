...
<div class="fatty index">
	<h2><?php echo __('Mes Présentations'); ?>
		<small class="pull-right">	
			<span>	<?php echo $cours['titre']?></span>
		</small>
	</h2>
	<p>Ajouter une présentation dans la catégorie: <?php echo $this->Html->link( $focus, array('action' => 'add'), array('class'=>'add')); ?> </p>
...
<?php endforeach; ?>
	...
	<div class="row"><span class="pull-right">
		<?php echo $this->Html->link(__('Ajouter une Présentation'), array('action' => 'add'), array('class'=>'add')); ?></span>
	</div>
