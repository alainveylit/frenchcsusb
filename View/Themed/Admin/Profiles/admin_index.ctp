			...
			<tr>
				...
				<td>
					<?php echo $this->Html->link($profile['Profile']['name'], 
						array('action'=>'view', 'admin'=>false, $profile['Profile']['id']),
				...
				<td>
					<?php  echo $this->Html->link($profile['Profile']['user_id'], 
					array('controller'=>'users', 'action'=>'view', 'admin'=>true, $profile['Profile']['user_id']));
					?>
				</td>						
