...
<?php //debug($test);?>
<div>
	<h2><?php echo __('Test'); ?>: <?php echo h($test['Test']['title']); ?></h2>
	<hr>
	<dl class="dl-horizontal">
		...
		<dd>
			<?php echo $this->Html->link($test['Document']['Creator']['name'], array('controller' => 'documents', 'action' => 'view', $test['Document']['id'])); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo $this->Html->link($test['Lesson']['titre'], array('controller' => 'lessons', 'action' => 'view', $test['Lesson']['id'])); ?>
			&nbsp;
		</dd>
