...
<div class="cartouche">
	...
	<dl class="dl-horizontal">
		...
		<dd>
			...
			array('controller' => 'users', 'action' => 'view', $document['Creator']['id'], 'admin'=>false)); ?>
			&nbsp;
		</dd>
	...
	<div class="actions">
		<h3><?php echo __('Actions'); ?></h3>
			<ul class="list-inline">
				...
				<li><span class="glyphicon glyphicon-edit"> </span> <?php echo $this->Html->link(__('Edit Document'), array('action' => 'edit', $document['Document']['id'])); ?> </li>
				<li><span class="glyphicon glyphicon-remove"> </span> <?php echo $this->Form->postLink(__('Delete Document'), 
				array('action' => 'delete', $document['Document']['id']),  array('class'=>'cut'), __('Are you sure you want to delete # %s?', $document['Document']['id'])); ?> </li>
				<?php endif;?>
