<div class="fatty index">
	...
	<tr>
		...
		<?php if($User['role']=='Admin'):?>
			<td class="actions">
				<?php echo $this->Html->link(__('Lire'), array('action' => 'view', 'admin'=>true, $quiz['Quiz']['id'])); ?>
				<?php echo $this->Html->link(__('Editer'), array('action' => 'edit', 'admin'=>true, $quiz['Quiz']['id'])); ?>
				<?php echo $this->Form->postLink(__('Effacer'), array('action' => 'delete', 'admin'=>true, $quiz['Quiz']['id']), array(), __('Are you sure you want to delete # %s?', $quiz['Quiz']['id'])); ?>
			</td>
		<?php endif;?>
	</tr>
<?php endforeach; ?>
