<div class="instances index">
	...
	<tr>
		<td><?php echo h($instance['Instance']['id']); ?>&nbsp;</td>
		...
		<td><?php echo h($instance['Instance']['password']); ?>&nbsp;</td>
		<td><?php echo h($instance['Instance']['expires']); ?>&nbsp;</td>
		<td><?php echo h($instance['Instance']['created']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $instance['Instance']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $instance['Instance']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $instance['Instance']['id']), array(), __('Are you sure you want to delete # %s?', $instance['Instance']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
