...
<?php echo $this->Form->create('Instance'); ?>
	<fieldset>
		<legend><?php echo __('Edit Instance'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Instance.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Instance.id'))); ?></li>
