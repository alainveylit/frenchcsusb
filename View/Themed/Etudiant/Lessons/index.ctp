	...
	<tr>
		...
		<td class="actions">
			...
			<?php if($User['role']=='Admin'):?>
				<?php echo $this->Html->link(__('Editer'), array('action' => 'edit', $lesson['Lesson']['id'])); ?>
				<?php echo $this->Form->postLink(__('Effacer'), array('action' => 'delete', $lesson['Lesson']['id']), array(), __('Are you sure you want to delete # %s?', $lesson['Lesson']['id'])); ?>
			<?php endif;?>
		</td>
	</tr>
	<?php endforeach; ?>
